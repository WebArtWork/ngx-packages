...
export class HttpService {
	...
	private readonly _urlStorageKey = 'ngx-crud.url';
	private readonly _legacyUrlStorageKey = 'ngx-http.url';
	private readonly _headersStorageKey = 'ngx-crud.headers';
	private readonly _legacyHeadersStorageKey = 'ngx-http.headers';
